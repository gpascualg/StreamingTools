...
var tablet_pressure = _interopDefault(require('tablet_pressure'));
...
function init() {
    ...
    tool.onMouseDrag = function(event) {
        var pressure = minPressure + offPressure * Math.max(0, electron.ipcRenderer.sendSync('get-pressure') / 2048.0);
