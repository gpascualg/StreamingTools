...
$(document).ready(function() {
    ...
    {
        electron.ipcRenderer.send('gapi-query-queue0', {url: 'https://www.googleapis.com/gmail/v1/users/me/threads/' + thread.id + '?fields=messages%2Fpayload%2Fheaders'});
        electron.ipcRenderer.send('gapi-query-queue0',
            {
    ...
    setInterval(function() {
        electron.ipcRenderer.send('gapi-query-queue0', {url: 'https://www.googleapis.com/gmail/v1/users/me/threads?q=' + encodeURIComponent('is:unread suscrito')});
    ...
    electron.ipcRenderer.on('gapi-response-queue0', function(event, args) {
        console.log(args);
